import { getApplicationsToRedact } from './get-applications-to-redact'
import {
  getFailedApplicationRedact,
  createApplicationRedact
} from '../repositories/application-redact-repository'
import {
...
describe('get-applications-to-redact', () => {
  ...
  it('should create applications to redact and return new applications when there are not previous failed application redact attempts', async () => {
    ...
    when(getApplicationsBySbi)
      .calledWith('123456789')
      .mockResolvedValueOnce([
        { reference: 'IAHW-7C72-8871', createdAt: '2025-04-05T00:00:00.000Z' },
        { reference: 'IAHW-1A12-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('223456789')
      .mockResolvedValueOnce([
        { reference: 'IAHW-8C72-8871', createdAt: '2025-06-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('323456789')
      .mockResolvedValueOnce([
        { reference: 'IAHW-9C72-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('423456789')
      .mockResolvedValueOnce([
        { reference: 'AHWR-7C72-8871', createdAt: '2025-12-05T00:00:00.000Z' }
      ])
    ...
    expect(result).toEqual({
      applicationsToRedact: [
        ...
        },
        {
          ...
          data: {
            sbi: '423456789',
            claims: [{ reference: 'AHWR-7C72-8871' }],
    ...
    const failedApplications = [
      {
        ...
        data: { sbi: '123456789', claims: [{ reference: 'REBC-1' }] }
      },
      {
        reference: 'IAHW-8C72-8871',
        requestedDate,
        status: 'applications-to-redact,documents',
        data: { sbi: '223456789', claims: [{ reference: 'REBC-2' }] }
      }
    ]
  ...
  it('should return old world application redact data when present', async () => {
    ...
    when(getApplicationsBySbi)
      .calledWith('123456789')
      .mockResolvedValueOnce([
        { reference: 'AHWR-7C72-8871', createdAt: '2025-04-05T00:00:00.000Z' },
        { reference: 'IAHW-1A12-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('223456789')
      .mockResolvedValueOnce([
        { reference: 'AHWR-8C72-8871', createdAt: '2025-04-05T00:00:00.000Z' },
        { reference: 'IAHW-1A12-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('323456789')
      .mockResolvedValueOnce([
        { reference: 'AHWR-9C72-8871', createdAt: '2025-04-05T00:00:00.000Z' },
        { reference: 'IAHW-1A12-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    ...
    expect(result).toEqual({
      applicationsToRedact: [
        ...
        },
        {
          ...
          data: {
            sbi: '223456789',
            claims: [{ reference: 'AHWR-8C72-8871' }],
            startDate: '2025-04-05T00:00:00.000Z',
            endDate: '2025-08-05T00:00:00.000Z'
          }
        },
        {
          ...
          data: {
            sbi: '323456789',
            claims: [{ reference: 'AHWR-9C72-8871' }],
            startDate: '2025-04-05T00:00:00.000Z',
            endDate: '2025-08-05T00:00:00.000Z'
          }
        }
  ...
  it('should return non-paid old world and new world applications to redact older than 3 years', async () => {
    ...
    getByApplicationReference.mockImplementation((reference) => {
      if (reference === 'IAHW-9C72-8873') {
        return [{ statusId: 'PAID', reference: 'REBC-1' }]
      }
      if (reference === 'IAHW-9C72-8874') {
        return [{ statusId: 3, reference: 'REBC-2' }]
      }
    })
    when(getApplicationsBySbi)
      .calledWith('123456789')
    ...
    when(getApplicationsBySbi)
      .calledWith('223456789')
      .mockResolvedValueOnce([
        { reference: 'AHWR-8C72-8872', createdAt: '2025-04-05T00:00:00.000Z' },
        { reference: 'IAHW-1A12-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('323456789')
      .mockResolvedValueOnce([
        { reference: 'IAHW-9C72-8873', createdAt: '2025-04-05T00:00:00.000Z' },
        { reference: 'IAHW-1A12-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('423456789')
      .mockResolvedValueOnce([
        { reference: 'IAHW-9C72-8874', createdAt: '2025-04-05T00:00:00.000Z' },
        { reference: 'IAHW-1A12-8871', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
  ...
  it('should return application to redact with its latest claim lastUpdated over seven years', async () => {
    ...
    getByApplicationReference.mockImplementation((reference) => {
      if (reference === 'IAHW-9C72-8873') {
        return [{ statusId: 8, reference: 'REBC-1' }]
      }
      if (reference === 'IAHW-9C72-8874') {
        return [{ statusId: 3, reference: 'REBC-2' }]
      }
    ...
    when(getApplicationsBySbi)
      .calledWith('223456789')
      .mockResolvedValueOnce([
        { reference: 'AHWR-7C72-8872', createdAt: '2025-06-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('323456789')
      .mockResolvedValueOnce([
        { reference: 'IAHW-9C72-8873', createdAt: '2025-08-05T00:00:00.000Z' }
      ])
    when(getApplicationsBySbi)
      .calledWith('423456789')
      .mockResolvedValueOnce([
        { reference: 'IAHW-9C72-8874', createdAt: '2025-12-05T00:00:00.000Z' }
      ])
    ...
    expect(result).toEqual({
      applicationsToRedact: [
        ...
        },
        {
          ...
          data: {
            sbi: '223456789',
            claims: [{ reference: 'AHWR-7C72-8872' }],
            startDate: '2025-06-05T00:00:00.000Z'
          }
        }
      ],
  ...
  it('should return unique agreements', async () => {
    ...
    when(getApplicationsBySbi)
      .calledWith('423456789')
      .mockResolvedValue([{ reference: 'AHWR-7C72-8871', createdAt: '2025-06-05T00:00:00.000Z' }])
