...
export const redactApplicationEventPII = async (_sbi, _logger, _startDate, _endDate) => {
  // TODO 1182 impl
  ...
  //       REDACT_PII_VALUES.REDACTED_LATEST_ENDEMICS_APPLICATION,
  //     latestVetVisitApplication:
  //       REDACT_PII_VALUES.REDACTED_LATEST_VET_VISIT_APPLICATION,
  //     relevantReviewForEndemics:
  //       REDACT_PII_VALUES.REDACTED_RELEVANT_REVIEW_FOR_ENDEMICS,
