...
| `POST: /api/claims/withdraw`                           | Withdraw a claim, recording the reasons in the withdrawal-requests collection       |
...
We are using forward-proxy which is set up by default for Wreck.
